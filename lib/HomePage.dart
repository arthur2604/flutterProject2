...
class _HomePageState extends State<HomePage> {
  ...
  Map<int, bool> selectedItems = {}; // To track selected items for deletion
  ...
  Future<void> addItem(String name, String dropdownValue) async {
    final response = await http.post(
      Uri.parse('http://192.168.0.107/maryam/add.php'),
  ...
  Future<void> deleteSelectedItems() async {
    ...
    if (idsToDelete.isNotEmpty) {
      final response = await http.post(
        Uri.parse('http://192.168.0.107/maryam/delete.php'),
